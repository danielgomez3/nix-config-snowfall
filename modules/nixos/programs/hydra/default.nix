# hydra.nix
{
  ...
  cfg = config.profiles.${namespace}.my.nixos.programs.hydra;
  inherit (lib) mkEnableOption mkIf;
in {
  options.profiles.${namespace}.my.nixos.programs.hydra = {
    enable = mkEnableOption "Enable custom 'nixos', module 'hydra', for namespace '${namespace}'.";
  };
